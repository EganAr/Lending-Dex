...
import { faucetDai } from "@/web3";
import Image from "next/image";
import { Loader2 } from "lucide-react";
import { useToast } from "@/hooks/use-toast";

export default function FaucetDaiButton() {
  ...
  const handleFaucet = async (e: React.FormEvent) => {
    ...
    try {
      await faucetDai(amount, account);

      toast({
        title: "Success!",
        description: "Your Faucet DAI was successful.",
    ...
    <div>
      ...
      >
        <div className="flex items center justify-between">
          <h1 className="text-2xl font-bold">Faucet DAI</h1>
