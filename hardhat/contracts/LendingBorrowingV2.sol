...
contract LendingBorrowingV2 is ReentrancyGuard {
    ...
    using OracleLib for PriceFeedAdapter;
    ...
    function calculateNetWorth(address _user) public view returns (uint256) {
        ...
        return (collateralAmount * collateralPrice) / 1e18 - (borrowedAmount * borrowedPrice) / 1e18;
    }
